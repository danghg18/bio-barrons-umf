...
const ASSETS = [
  ...
  BASE + 'sistemul_nervos.html',
  BASE + 'grile_sistemul_nervos.html',
  BASE + 'sistemul_renal_complet.html',
  BASE + 'sistemul_reproducator_masculin.html',
  BASE + 'sistemul_reproducator_feminin.html',
  BASE + 'assets/js/chapter-redesign.js?v=20260907-nervous11',
  BASE + 'assets/css/tokens.css',
  BASE + 'assets/css/lesson.css',
  BASE + 'assets/css/chapter-redesign.css?v=20260727-highlighter6',
  BASE + 'assets/css/quiz.css?v=20260907-quiz4',
  BASE + 'assets/css/home-redesign.css?v=20260717-atlas5',
  BASE + 'assets/js/grile-sistemul-nervos-data.js?v=20260907-quiz4',
  BASE + 'assets/js/quiz-player.js?v=20260907-quiz4',
  BASE + 'manifest.json',
  ...
  BASE + 'img sistem nervos/regiuni_SN_barrons.png.webp',
  BASE + 'img sistem nervos/structuri_SN_barrons.png.webp',
  BASE + 'img sistem nervos/MS_transversal_barrons.png.webp',
  BASE + 'img sistem nervos/encefal_barrons.png.webp',
  BASE + 'img sistem nervos/lateral_encefal_barrons.png.webp',
  BASE + 'img sistem nervos/ventriculi_cerebrali_barrons.png.webp',
  BASE + 'img sistem nervos/TC_diencefal_barrons.png.webp',
  BASE + 'img sistem nervos/nervi_cranieni_barrons.png.webp',
  BASE + 'img sistem nervos/SNP_barrons.png.webp',
  BASE + 'img sistem nervos/SNV_barrons.png.webp',
