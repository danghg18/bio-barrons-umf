...
Pe alt dispozitiv, imaginile se descarcă prin clientul autentificat și intră în cacheul privat local. Offline sunt disponibile imaginile deja adăugate sau descărcate pe dispozitivul respectiv. Nu există URL public și nu se salvează URL-uri temporare în corpul notiței. Eliminarea unei imagini din text elimină referința; fișierul nu este șters imediat din Storage/IndexedDB, deoarece copii salvate anterior sau conflicte pot încă să îl refere. Exportul JSON existent include textul și referințele, **nu bloburile imaginilor**; nu constituie un export complet al anexelor.
